...
import { Zap, PhoneCall, Star, BadgeCheck, Clock } from "lucide-react";

export default function ElectricianPage() {
  const electricians = [
    { name: "PowerFix Electricals", experience: "6+ Years", rating: 4.8, available: "24/7", img: "https://i.ibb.co/xFSwCg6/electrician1.png", location: "Indore" },
    { name: "SafeWire Experts", experience: "4+ Years", rating: 4.6, available: "10AM - 8PM", img: "https://i.ibb.co/5Fjtnqj/electrician2.png", location: "Ujjain" },
    { name: "CurrentCare Services", experience: "8+ Years", rating: 4.9, available: "24/7", img: "https://i.ibb.co/5Rn7Wx8/electrician3.png", location: "Ratlam" }
  ];
    ...
    <div className="min-h-screen w-full bg-gray-50 text-gray-800">
      ...
      <div className="bg-teal-600 text-white py-16 px-6 text-center">
        <h1 className="text-4xl font-bold mb-3 flex justify-center items-center gap-2">
          <Zap className="w-10 h-10" /> Verified Electricians
        </h1>
        <p className="text-lg max-w-2xl mx-auto opacity-90">
          Reliable electrical solutions: Wiring, Appliance Repair, Safety System Installation & more.
        </p>
      </div>
      ...
      <div className="bg-teal-600 text-white text-center py-10 mt-10">
        <h3 className="text-2xl font-semibold">Need an electrician urgently?</h3>
        <p className="opacity-90 mt-1">We are ready to help anytime.</p>
